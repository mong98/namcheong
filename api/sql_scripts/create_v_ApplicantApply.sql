...
/****** Object:  View [dbo].[v_ApplicantApply]    Script Date: 14/12/2020 12:50:23 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT        dbo.ApplicantApply.Id, dbo.ApplicantApply.Position AS ApplyPosition, dbo.ApplicantApply.PositionID AS ApplyPositionID, 
                         ...
                         dbo.Applicant.LoginEmail, dbo.Applicant.Password, dbo.Applicant.Name, dbo.Applicant.Gender, dbo.Applicant.IC, dbo.Applicant.Passport, dbo.Applicant.ValidityDate, 
