...
const controller = require('../controller/IssuingAuthorityController')
...
router.get('/get_issuingauthority', controller.getIssuingAuthority);
router.post('/add_issuingauthority/' , controller.addIssuingAuthority);
router.put('/update_issuingauthority/',controller.updateIssuingAuthority);
router.delete('/delete_issuingauthority/:Id' , controller.deleteIssuingAuthority);
