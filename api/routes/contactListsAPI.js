...
const controller = require('../controller/contactListController')
...
router.get('/get_contact_lists', controller.getContactLists);
router.post('/add_contact_lists/' , controller.addContactLists);
